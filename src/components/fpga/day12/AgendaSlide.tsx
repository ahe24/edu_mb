...
const agenda: Item[] = [
  {
    step: 1,
    title: 'UART 프로토콜',
    desc: 'start/data/stop frame · baud rate · bit period · 비동기 직렬.',
    color: '#4A6FA5',
  },
  {
    step: 2,
    title: 'baud 생성',
    desc: 'baud tick generator · 16× oversampling · clk 분주비.',
    color: DAY12,
  },
  {
    step: 3,
    title: 'TX · RX 설계',
    desc: 'TX FSM + shift register · RX start 검출 + mid-bit 샘플.',
    color: '#0891B2',
  },
  {
    step: 4,
    title: '루프백 통합',
    desc: 'TX→RX 연결 · echo · 2FF 입력 동기화.',
    color: '#8B6FA5',
  },
  {
    step: 5,
    title: '프로토콜 검증 · Lab',
    desc: 'frame/bit-period 검사 · scoreboard · 4 실습 (오전2·오후2).',
    color: '#48BB78',
    isLab: true,
  },
];
