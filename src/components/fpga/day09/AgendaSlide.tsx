...
const agenda: Item[] = [
  {
    step: 1,
    title: '설계 기반 검증',
    desc: 'Month 2 방향 — 직접 만든 DUT 위에서 검증을 배운다 · Arty-7 자원 맵.',
    color: '#4A6FA5',
  },
  {
    step: 2,
    title: 'QuestaSim · Visualizer',
    desc: 'vlib → vlog → vsim 3단계 · 파형 디버깅 · 툴 부담 제거.',
    color: DAY09,
  },
  {
    step: 3,
    title: '조합논리 설계',
    desc: 'assign · sw→LED passthrough/invert · logic gates → RGB LED.',
    color: '#0891B2',
  },
  {
    step: 4,
    title: '4:1 MUX',
    desc: 'always @* · case · full-case로 latch 회피 · 선택 신호.',
    color: '#8B6FA5',
  },
  {
    step: 5,
    title: 'Testbench · Lab',
    desc: '첫 self-checking TB · Visualizer 파형 읽기 · 4 실습 (오전2·오후2).',
    color: '#48BB78',
    isLab: true,
  },
];
