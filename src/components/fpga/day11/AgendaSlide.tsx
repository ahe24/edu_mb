...
const agenda: Item[] = [
  {
    step: 1,
    title: 'FSM 구조',
    desc: '상태 레지스터 + 다음상태 + 출력 · Moore/Mealy · encoding · 안전 상태.',
    color: '#4A6FA5',
  },
  {
    step: 2,
    title: '코딩 스타일',
    desc: '2-process 템플릿 · full-case default · illegal state → 안전 복구.',
    color: DAY11,
  },
  {
    step: 3,
    title: '신호등 · PWM',
    desc: '타이머 기반 신호등 Moore FSM · RGB PWM 밝기 모드 순환 FSM.',
    color: '#0891B2',
  },
  {
    step: 4,
    title: '시퀀스 검출',
    desc: '입력 패턴 검출 FSM · overlap 처리 · Moore 출력.',
    color: '#8B6FA5',
  },
  {
    step: 5,
    title: '천이 검증 · Lab',
    desc: '상태 천이 TB · corner case · state coverage · 4 실습 (오전2·오후2).',
    color: '#48BB78',
    isLab: true,
  },
];
