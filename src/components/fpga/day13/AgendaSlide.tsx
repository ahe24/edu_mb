...
const agenda: Item[] = [
  {
    step: 1,
    title: '모놀리식 TB의 한계',
    desc: 'Day12 TB 진단 · 자극/관찰/판정 혼재 · 재사용 불가.',
    color: '#4A6FA5',
  },
  {
    step: 2,
    title: '계층화 TB 구조',
    desc: 'driver · monitor · scoreboard 역할 분리 · tb_top 은 시나리오만.',
    color: DAY13,
  },
  {
    step: 3,
    title: 'SVA 기초',
    desc: 'concurrent assertion · |-> · ##N · $rose/$past · disable iff.',
    color: '#0891B2',
  },
  {
    step: 4,
    title: 'bind 비침습 결합',
    desc: 'RTL 무수정 checker 부착 · 내부 state 감시.',
    color: '#8B6FA5',
  },
  {
    step: 5,
    title: '버그 주입 회귀 · Lab',
    desc: 'fault injection 으로 TB 검출력 확인 · 4 실습 (순서 무관).',
    color: '#48BB78',
    isLab: true,
  },
];
